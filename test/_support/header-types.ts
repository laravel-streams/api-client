...
export interface StandardRequestHeaders {
     ...
     */
    'Accept-Charset'?: RequestHeaderValue
    /**
     ...
     */
    'Content-Type'?: RequestHeaderValue
    /**
...
export interface NonStandardRequestHeaders {
     ...
     * X-UIDH: ...
     */
    'X-UIDH[35][36]'?: RequestHeaderValue
    /**
     ...
     */
    'X-Request-ID,[41]            X-Correlation-ID[42][43]'?: RequestHeaderValue
    /**
...
export interface StandardResponseHeaders {
     ...
     */
    'Access-Control-Allow-Origin,Access-Control-Allow-Credentials,Access-Control-Expose-Headers,Access-Control-Max-Age,Access-Control-Allow-Methods,Access-Control-Allow-Headers'?: ResponseHeaderValue
    /**
     ...
     */
    'Content-Type'?: ResponseHeaderValue
    /**
...
export type RequestHeaders = StandardRequestHeaders|NonStandardRequestHeaders
export type ResponseHeaders = StandardResponseHeaders|NonStandardResponseHeaders
export type RequestHeader = keyof StandardRequestHeaders| keyof NonStandardRequestHeaders
export type ResponseHeader = keyof StandardResponseHeaders| keyof NonStandardResponseHeaders
export type Headers = StandardRequestHeaders | NonStandardRequestHeaders | StandardResponseHeaders | NonStandardResponseHeaders
export type Header = keyof StandardRequestHeaders | keyof NonStandardRequestHeaders | keyof StandardResponseHeaders | keyof NonStandardResponseHeaders |string